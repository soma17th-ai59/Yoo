...
def test_generator_skips_non_fillable_items(monkeypatch):
    ...
    state = GraphState(
        ...
        plans=[
            ItemPlan(item_id="s:tbl0:r0c0", source_evidence=[], confidence=0.5, needs_question=False),
            ItemPlan(item_id="s:tbl0:r0c1", source_evidence=[], confidence=0.5, needs_question=False),
        ],
    )
